...
export default async function sendPrompt(inputText: string, guidancePrompt: string): Promise<string> {
  const res = await fetch("https://airiedevapi-gwfcg9fyf4fwg2b2.australiaeast-01.azurewebsites.net/Airie/BasicChat", {
    method: "POST",
